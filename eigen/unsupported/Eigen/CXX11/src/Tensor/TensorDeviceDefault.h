...
struct DefaultDevice {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void memcpyHostToDevice(void* dst, const void* source, size_t n) const {
    memcpy(dst, source, n);
  }
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void memcpyDeviceToHost(void* dst, const void* source, size_t n) const {
    memcpy(dst, source, n);
  }
