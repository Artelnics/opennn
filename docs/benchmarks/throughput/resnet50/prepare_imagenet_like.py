...
#
# Writes to $OPENNN_BENCH_DATA/imagenet_like (fallback
# ~/opennn-benchmark-data/imagenet_like) so the large dataset stays outside the
# repository; pass [data_dir] to override.
#
...
DEFAULT_OUT = DEFAULT_BENCH_DATA / "imagenet_like"
