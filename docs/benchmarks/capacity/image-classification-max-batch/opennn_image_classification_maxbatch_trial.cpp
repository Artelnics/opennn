//   OpenNN GPU ImageClassificationNetwork max-batch trial.
//
//   One invocation = one batch attempt in its own process.
//
//   usage: opennn_image_classification_maxbatch_trial <cifar10_dir> <batch> [fp32]
                                               ...
                                               TempImageTree& temp)
{
    ...
    temp.root = fs::temp_directory_path()
              / ("opennn_image_classification_maxbatch_"
...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        ImageClassificationNetwork network(dataset.get_shape("Input"),
                                           Shape{16, 32, 64, 128},
        ...
        std::cout << "model=ImageClassificationNetwork-CIFAR\n";
        std::cout << "complexity=16,32,64,128\n";
