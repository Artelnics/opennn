...
The [ResNet-50 note](../../throughput/resnet50-training-speed/resnet50-training-speed-gpu-opennn-vs-pytorch.md) measures a
...
[training-precision note](../../quality/precision/precision-opennn-vs-pytorch-vs-tensorflow.md), widened
...
[`docs/benchmarks/capacity/rosenbrock-max-batch/`](rosenbrock-max-batch/) (see its
[`README.md`](README.md); the `build_*.sh` paths are
