...
([`../higgs/README.md`](../../throughput/higgs/README.md)): the largest batch that completes
...
CSV (see [`../higgs/README.md`](../../throughput/higgs/README.md)):
...
- **CPU mode** (`--device cpu`, fp32 only): the same matrix on the CPU, with
  ...
  [data-capacity benchmark](../data-capacity/data-capacity-opennn-vs-pytorch-vs-tensorflow.md)),
