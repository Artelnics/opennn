...
int main()
{
    const auto current_rss_mb = []() -> double
    {
#ifdef _WIN32
    ...
    const auto current_process_vram_mb = []() -> optional<double>
    {
#ifdef _WIN32
    ...
    const auto gpu_used_memory_mb = []() -> optional<double>
    {
#ifdef _WIN32
    ...
    const auto run_tiny_gpu_matmul = []
    {
