...
Drivers (built separately; see each benchmark's build_*.sh):
  ...
  dense        -> ../rosenbrock-max-batch/opennn_rosenbrock_resident_infer (infer)
                  ../rosenbrock-max-batch/opennn_rosenbrock_throughput      (train)
...
ROSE = os.path.normpath(os.path.join(HERE, "..", "rosenbrock-max-batch"))
