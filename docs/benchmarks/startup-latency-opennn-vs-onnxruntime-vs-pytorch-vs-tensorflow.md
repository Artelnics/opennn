...
ONNX Runtime, built for lean inference, starts far faster than the full frameworks (~237 ms) but is
still ~7× OpenNN's native binary, which pays no interpreter or framework-load cost.
