...
Writes an immutable result JSON to benchmarks/results/ named
accuracy-higgs-<run_id>.json with benchmark_id "accuracy-higgs".

Dataset paths follow benchmarks/DATA_POLICY.md: set OPENNN_BENCH_DATA and
...
# Shared provenance helpers: benchmarks/common. See DUPLICATION_LEDGER.md for
# what these looked like when every runner had its own.
