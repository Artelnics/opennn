...
```text
benchmarks/footprint/application-loc/opennn_iris.cpp
benchmarks/footprint/application-loc/pytorch_iris.py
benchmarks/footprint/application-loc/tensorflow_iris.py
```
...
```bash
cd benchmarks/footprint/application-loc
