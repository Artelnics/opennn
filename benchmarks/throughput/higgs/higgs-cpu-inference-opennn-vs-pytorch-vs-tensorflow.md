...
| Item | Value |
|---|---|
| Dataset | UCI HIGGS, prepared with `benchmarks/throughput/higgs/prepare_higgs.py` |
...
Local result JSON:
`benchmarks/results/cpu-dense-higgs-infer-20260704T-higgs100k-infer-b1024-mkl-threads20.json`
