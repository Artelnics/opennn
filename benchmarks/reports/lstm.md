...
recorded), and the runner sets `GOMP_SPINCOUNT=300000` for both — PROTOCOL §7
...
- **Different oneDNN builds on CPU.** OpenNN links oneDNN 3.11 with the
  ...
  (PROTOCOL §7); the remaining difference is the libgomp each engine links
