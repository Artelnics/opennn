...
TEST(PerceptronLayerTest, CombinationsDefault)
{
    /*
...
TEST(PerceptronLayerTest, CalculateCombinations) {
...
/*
    ...
    EXPECT_NEAR(combinations(0,0), type(7), type(1e-5));
    ...
    EXPECT_NEAR(combinations(0,0), type(3), type(NUMERIC_LIMITS_MIN));
    ...
    EXPECT_NEAR(combinations(0,0), type(3.5), type(NUMERIC_LIMITS_MIN));
    */
}

TEST(PerceptronLayerTest, CalculateActivations) {
...
/*
    ...
    perceptron_layer.calculate_activations(activations, activation_derivatives);
    EXPECT_NEAR(activations(0,0), type(1), type(NUMERIC_LIMITS_MIN));
    EXPECT_NEAR(activation_derivatives(0,0), type(1), type(NUMERIC_LIMITS_MIN));
*/
}
