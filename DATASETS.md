...
[Reproduction](#reproduction). They verify the indexed data
...
[the provenance review](#assets-still-requiring-clearance) and the `--release` inventory gate still apply.
