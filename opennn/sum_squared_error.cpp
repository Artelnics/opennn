...
double SumSquaredError::calculate_batch_error(const vector<int>& batch_indices, const Tensor<double, 1>& parameters) const
{
#ifdef __OPENNN_DEBUG__
...
/*
        ...
        const Tensor<double, 2> output_gradient = (forward_propagation[trainable_layers_number-1].activations - targets).divide(error_terms, 0);
...
Tensor<double, 2> SumSquaredError::calculate_output_gradient(const Tensor<double, 2>& outputs, const Tensor<double, 2>& targets) const
{
    #ifdef __OPENNN_DEBUG__
...
Tensor<double, 1> SumSquaredError::calculate_training_error_terms(const Tensor<double, 2>& outputs, const Tensor<double, 2>& targets) const
{
    #ifdef __OPENNN_DEBUG__
...
Tensor<double, 1> SumSquaredError::calculate_training_error_terms(const Tensor<double, 1>& parameters) const
{
    #ifdef __OPENNN_DEBUG__
...
Tensor<double, 1> SumSquaredError::calculate_squared_errors() const
{
   #ifdef __OPENNN_DEBUG__
...
/*
   ...
   Tensor<double, 1> squared_errors(batches_number);
   ...
   for(int i = 0; i < batches_number ; i++)
   {
      ...
      const Tensor<double, 2> inputs = data_set_pointer->get_input_data(batch_indices[static_cast<int>(i)]);
      ...
      const Tensor<double, 2> targets = data_set_pointer->get_target_data(batch_indices[static_cast<int>(i)]);
...
/*
    ...
    const Tensor<double, 2> regularization_hessian = calculate_regularization_hessian();
