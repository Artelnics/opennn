...
/*
    ...
    Tensor<type, 2> image(vector<int>({filters_number, outputs_rows_number, outputs_columns_number}));
...
/*
    ...
    Tensor<type, 2> hidden_delta(vector<int>({images_number, filters_number, output_rows_number, output_columns_number}));
