...
StreamCapture::StreamCapture(cudaStream_t) { throw runtime_error("CUDA support is not compiled in."); }
StreamCapture::~StreamCapture() noexcept {}
GraphHandle StreamCapture::end() { throw runtime_error("CUDA support is not compiled in."); }
void instantiate_or_update(GraphExecHandle&, cudaGraph_t) { throw runtime_error("CUDA support is not compiled in."); }
void launch_graph(const GraphExecHandle&, cudaStream_t) { throw runtime_error("CUDA support is not compiled in."); }
