...
void PerceptronLayer3D::forward_propagate(const pair<type*, dimensions>& inputs,
                                        LayerForwardPropagation* layer_forward_propagation,
                                        const bool& is_training)
{
    const TensorMap<Tensor<type, 3>> inputs_map(inputs.first, inputs.second[0][0], inputs.second[0][1], inputs.second[0][2]);
                                             ...
                                             LayerBackPropagation* layer_back_propagation) const
{
    ...
    {
        ProbabilisticLayer3DForwardPropagation* next_probabilistic_layer_forward_propagation =
                reinterpret_cast<ProbabilisticLayer3DForwardPropagation*>(next_forward_propagation);

        ProbabilisticLayer3DBackPropagation* next_probabilistic_layer_back_propagation =
                                             ...
                                             PerceptronLayer3DBackPropagation* back_propagation) const
{
    ...
    const Tensor<type, 4>& next_activations_derivatives = next_forward_propagation->activations_derivatives;
    ...
    if(next_neurons_number == 1)
    {
        ...
        const Tensor<type, 2> next_activations_derivatives_matrix = next_activations_derivatives.reshape(reshape_dimensions);

        deltas.device(*thread_pool_device) =
            (next_deltas*next_activations_derivatives_matrix).contract(next_synaptic_weights, A_BT);
    }
    else
    {
...
void PerceptronLayer3D::calculate_hidden_delta_lm(LayerForwardPropagation* next_forward_propagation,
                                                LayerBackPropagationLM* next_back_propagation,
                                                LayerBackPropagationLM* layer_back_propagation) const
{

    PerceptronLayer3DBackPropagationLM* perceptron_layer_back_propagation =
            static_cast<PerceptronLayer3DBackPropagationLM*>(layer_back_propagation);
    ...
    {
        PerceptronLayer3DForwardPropagation* next_perceptron_layer_forward_propagation =
                static_cast<PerceptronLayer3DForwardPropagation*>(next_forward_propagation);

        PerceptronLayer3DBackPropagationLM* next_perceptron_layer_back_propagation =
                static_cast<PerceptronLayer3DBackPropagationLM*>(next_back_propagation);
    ...
    {
        ProbabilisticLayer3DForwardPropagation* next_probabilistic_layer_forward_propagation =
                static_cast<ProbabilisticLayer3DForwardPropagation*>(next_forward_propagation);

        ProbabilisticLayer3DBackPropagationLM* next_probabilistic_layer_back_propagation =
                static_cast<ProbabilisticLayer3DBackPropagationLM*>(next_back_propagation);
...
void PerceptronLayer3D::calculate_hidden_delta_lm(PerceptronLayer3DForwardPropagation* next_forward_propagation,
                                                PerceptronLayer3DBackPropagationLM* next_back_propagation,
                                                PerceptronLayer3DBackPropagationLM* back_propagation) const
{
    const PerceptronLayer3D* next_perceptron_layer
        = static_cast<PerceptronLayer3D*>(next_back_propagation->layer_pointer);
...
void PerceptronLayer3D::calculate_hidden_delta_lm(ProbabilisticLayer3DForwardPropagation* next_forward_propagation,
                                                ProbabilisticLayer3DBackPropagationLM* next_back_propagation,
                                                PerceptronLayer3DBackPropagationLM* back_propagation) const
{
    const ProbabilisticLayer3D* probabilistic_layer_pointer = static_cast<ProbabilisticLayer3D*>(next_back_propagation->layer_pointer);
