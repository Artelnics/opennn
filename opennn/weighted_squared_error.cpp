...
double WeightedSquaredError::calculate_batch_error(const Tensor<Index, 1>& batch_indices) const
{
    #ifdef __OPENNN_DEBUG__
...
double WeightedSquaredError::calculate_batch_error(const Tensor<Index, 1>& batch_indices,
