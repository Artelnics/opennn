...
/// Default constructor.
/// It creates an empty ConcatenationLayer object.
...
Tensor<Index, 1> ConcatenationLayer::get_outputs_dimensions() const
{
...
Index ConcatenationLayer::get_inputs_number() const
{
...
Index ConcatenationLayer::get_inputs_rows_number() const
{
...
Index ConcatenationLayer::get_channels_number() const
{
...
Index ConcatenationLayer::get_outputs_rows_number() const
{
    return 0;
}
...
Index ConcatenationLayer::get_parameters_number() const
{
    return 0;
}
...
Tensor<type, 1> ConcatenationLayer::get_parameters() const
{
...
Tensor<Index, 1> ConcatenationLayer::get_inputs_dimensions() const
{
    return inputs_dimensions;
}


void ConcatenationLayer::set(const Tensor<Index, 1>& new_input_variables_dimensions, const Tensor<Index, 1>& new_pool_dimensions)
{
    inputs_dimensions = new_input_variables_dimensions;
...
void ConcatenationLayer::set_name(const string& new_layer_name)
{
...
void ConcatenationLayer::set_inputs_dimensions(const Tensor<Index, 1>& new_inputs_dimensions)
{
...
void ConcatenationLayer::set_default()
{
...
void ConcatenationLayer::write_XML(tinyxml2::XMLPrinter& file_stream) const
{
    ostringstream buffer;

    // Pooling layer

    file_stream.OpenElement("ConcatenationLayer");
...
void ConcatenationLayer::from_XML(const tinyxml2::XMLDocument& document)
{
    ostringstream buffer;

    // Pooling layer

    const tinyxml2::XMLElement* pooling_layer_element = document.FirstChildElement("ConcatenationLayer");

    if(!pooling_layer_element)
    {
        buffer << "OpenNN Exception: ConcatenationLayer class.\n"
