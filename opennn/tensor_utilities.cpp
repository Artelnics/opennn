...
VectorR vector_from_device(const type* pointer, size_t new_size)
{
    if (new_size == 0) return VectorR();
...
MatrixR matrix_from_device(const type* pointer, size_t new_rows_number, size_t new_variables_number)
{
    if (new_rows_number == 0 || new_variables_number == 0) return MatrixR();
...
Tensor3 tensor3_from_device(const type* pointer, size_t new_depth_number, size_t new_rows_number, size_t new_columns_number)
{

    if (new_depth_number == 0 || new_rows_number == 0 || new_columns_number == 0) return Tensor3();
...
Tensor4 tensor4_from_device(const type* pointer, size_t new_batch_samples_number, size_t new_rows_number, size_t new_columns_number, size_t new_channels_number)
{

    if (new_batch_samples_number == 0 || new_rows_number == 0 || new_columns_number == 0 || new_channels_number == 0) return Tensor4();
