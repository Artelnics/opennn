                      ...
                      const Index& layers_number)
{
    ...
    add_layer(std::move(input_embedding_layer),vector<Index>());
    ...
    add_layer(std::move(context_embedding_layer),vector<Index>());
    ...
    for(Index i = 0; i < layers_number; i++)
    {
        ...
        add_layer(std::move(context_self_attention_layer),vector<Index>());
        ...
        add_layer(std::move(context_self_attention_addition_layer),vector<Index>());
        ...
        add_layer(std::move(context_self_attention_normalization_layer),vector<Index>());
        ...
        add_layer(std::move(encoder_internal_perceptron_layer),vector<Index>());
        ...
        add_layer(std::move(encoder_external_perceptron_layer),vector<Index>());
        ...
        add_layer(std::move(encoder_perceptron_addition_layer),vector<Index>());
        ...
        add_layer(std::move(encoder_perceptron_normalization_layer),vector<Index>());
    ...
    for(Index i = 0; i < layers_number; i++)
    {
        ...
        add_layer(std::move(input_self_attention_layer),vector<Index>());
        ...
        add_layer(std::move(input_self_attention_addition_layer),vector<Index>());
        ...
        add_layer(std::move(input_self_attention_normalization_layer),vector<Index>());
        ...
        add_layer(std::move(cross_attention_layer),vector<Index>());
        ...
        add_layer(std::move(cross_attention_addition_layer),vector<Index>());
        ...
        add_layer(std::move(cross_attention_normalization_layer),vector<Index>());
        ...
        add_layer(std::move(decoder_internal_perceptron_layer),vector<Index>());
        ...
        add_layer(std::move(decoder_external_perceptron_layer),vector<Index>());
        ...
        add_layer(std::move(decoder_perceptron_addition_layer),vector<Index>());
        ...
        add_layer(std::move(decoder_perceptron_normalization_layer),vector<Index>());
    ...
    add_layer(std::move(final_layer),vector<Index>());
