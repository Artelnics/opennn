...
//                cout << activations_derivatives(row,i,j) << endl;
                index++;
            }
        }
    }
...
//    cout << "( " << activations_derivatives.dimension(0) << "," << activations_derivatives.dimension(1) << "," << activations_derivatives.dimension(2) << ") " <<endl;
