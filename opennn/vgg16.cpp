...
VGG16::VGG16() : NeuralNetwork()
{
    ...
    pooling_layer_1.set_raw_variable_stride(2);
   ...
   // Block 2
    ...
    load_parameters_binary("../../parameters/vgg16_weights.bin");

    outputs_names.setValues({"tench",
                             "goldfish",
                             "great_white_shark",
                             "tiger_shark",
                             "hammerhead",
