...
/// @param initial_learning_rate Initial learning rate in line minimization.
...
/// Returns the learning rate by searching in a given direction to locate the minimum of the loss
