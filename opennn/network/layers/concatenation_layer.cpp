...
#include "opennn/network/layers/kernel_concat.cuh"
#endif

namespace opennn
{

void ConcatenationOperator::forward_propagate(ForwardPropagation& forward_propagation, size_t layer, ForwardPropagationMode)
{
