...
//   www.opennn.net
//
//   N E T W O R K   C L A S S   H E A D E R
//
...
private:
    ...
    {
        explicit HostStatesGuard(Network& n)
            : HostStatesGuard(n, n.states.get_device() == Device::CUDA) {}

        HostStatesGuard(Network& n, bool stage)
