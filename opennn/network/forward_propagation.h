...
struct ForwardPropagation
{
    ...
    ForwardPropagation(Index, Network*,
    ...
    void set(Index, Network*, Buffer* external_storage = nullptr,
             ForwardPropagationMode = ForwardPropagationMode::Training,
             InferenceShapePolicy = {},
             bool inputs_pre_scaled = false,
             span<const MemoryPoolEntry> co_planned_lifetimes = {},
    ...
    // Network definition. Returns 0 when there is no network, which every
