...
void FlattenLayerForwardPropagation::set(const Index& new_batch_size, Layer* new_layer)
{
...
void FlattenLayerBackPropagation::set(const Index& new_batch_size, Layer* new_layer)
{
    layer = new_layer;
