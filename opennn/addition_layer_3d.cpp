...
AdditionLayer3DForwardPropagationCuda::AdditionLayer3DForwardPropagationCuda(const Index& new_batch_samples_number, Layer* new_layer)
...
pair<type*, dimensions> AdditionLayer3DForwardPropagationCuda::get_outputs_pair_device() const
{
...
AdditionLayer3DBackPropagationCuda::AdditionLayer3DBackPropagationCuda(const Index& new_batch_samples_number, Layer* new_layer)
...
vector<pair<type*, dimensions>> AdditionLayer3DBackPropagationCuda::get_input_derivative_pairs_device() const
{
