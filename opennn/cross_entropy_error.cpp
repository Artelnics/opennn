...
double CrossEntropyError::calculate_batch_error(const VectorXi& batch_indices) const
{
...
double CrossEntropyError::calculate_batch_error(const VectorXi& batch_indices, const Tensor<type, 1>& parameters) const
{
#ifdef __OPENNN_DEBUG__
...
LossIndex::FirstOrderLoss CrossEntropyError::calculate_first_order_loss(const DataSet::Batch& batch) const
{
#ifdef __OPENNN_DEBUG__
