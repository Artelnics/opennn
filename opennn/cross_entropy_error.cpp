...
double CrossEntropyError::calculate_minimum_performance(void) const
{
    // Neural network stuff
...
Matrix<double> CrossEntropyError::calculate_output_Hessian(const Vector<double>& , const Vector<double>& ) const
{
