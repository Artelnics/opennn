...
//   batch_1.fill(training_samples_indices, inputs_indices, targets_indices);
...
//   batch_2.fill(training_samples_indices, inputs_indices, targets_indices);
...
void SumSquaredErrorTest::test_calculate_output_gradient() // @todo
{
