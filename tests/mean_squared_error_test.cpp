...
//    Test trivial
{
    ...
    LossIndex::BackPropagation training_back_propagation(samples_number, &mean_squared_error);
    ...
    numerical_error_gradient = mean_squared_error.calculate_error_gradient_numerical_differentiation(&mean_squared_error);
