...
TEST(DropoutLayerTest, TrainingPassDiffersFromInference)
{
    ...
    ForwardPropagation training_propagation(batch_size, &network);
    ...
    ForwardPropagation second_propagation(batch_size, &network);
    ...
    network.forward_propagate(training_views, training_propagation, ForwardPropagationMode::Training);
