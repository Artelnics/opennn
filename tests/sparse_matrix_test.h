...
#ifndef __SPARSEMATRIXTEST_H__
#define __SPARSEMATRIXTEST_H__
...
class SparseMatrixTest : public UnitTesting
{
...
private:
   ...
   static Vector<double> dot(const SparseMatrix<double>&, const Vector<double>&);

   static SparseMatrix<double> dot(const SparseMatrix<double>&, const SparseMatrix<double>&);
};
