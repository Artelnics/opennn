...
void DataSetTest::test_calculate_input_columns_correlations()
{
    ...
    Tensor<Correlation, 2> inputs_correlations = data_set.calculate_input_columns_correlations(true,true)(1);
    ...
    inputs_correlations = data_set.calculate_input_columns_correlations(true, true)(1);
