...
TEST(Addition3dTest, GeneralConstructor)
{
    ...
    Addition<3> addition_3d_layer({sequence_length, embedding_dimension});
...
TEST(Addition3dTest, ForwardPropagate)
{
    ...
    neural_network.add_layer(make_unique<Addition<3>>(dimensions({sequence_length, embedding_dimension})));
