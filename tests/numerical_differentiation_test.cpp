...
//   Tensor<type, 1> d5 = numerical_differentiation.calculate_central_differences_derivatives(*this, &NumericalDifferentiationTest::f3_1, dummy_index, x_1d);
...
//   Tensor<type, 1> d5 = nunmerical_differentiation.calculate_central_differences_derivatives(*this, &NumericalDifferentiationTest::f3_1, dummy_index, x_1d);
...
void NumericalDifferentiationTest::test_calculate_derivatives()
{
    ...
    type d2 = numerical_differentiation.calculate_forward_differences_derivatives(*this, &NumericalDifferentiationTest::f1, type(0));

    assert_true(abs(d - d2) < type(NUMERIC_LIMITS_MIN), LOG);
    ...
    d2 = numerical_differentiation.calculate_central_differences_derivatives(*this, &NumericalDifferentiationTest::f1, type(0));
    ...
    Tensor<type, 1> d2_2 = numerical_differentiation.calculate_forward_differences_derivatives(*this, &NumericalDifferentiationTest::f2, x_1d);

    assert_true(abs(d_2(0) - d2_2(0)) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(d_2(1) - d2_2(1)) < type(NUMERIC_LIMITS_MIN), LOG);
    ...
    d2_2 = numerical_differentiation.calculate_central_differences_derivatives(*this, &NumericalDifferentiationTest::f2, x_1d);
    ...
    Tensor<type, 2> d2_3 = numerical_differentiation.calculate_forward_differences_derivatives(*this, &NumericalDifferentiationTest::f3, x_2d);

    assert_true(abs(d_3(0) - d2_3(0)) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(d_3(1) - d2_3(1)) < type(NUMERIC_LIMITS_MIN), LOG);
    ...
    d2_3 = numerical_differentiation.calculate_central_differences_derivatives(*this, &NumericalDifferentiationTest::f3, x_2d);

    assert_true(abs(d_3(0,0) - d2_3(0,0)) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(d_3(0,1) - d2_3(0,1)) < type(NUMERIC_LIMITS_MIN), LOG);
    ...
    Tensor<type, 1> d2_4 = numerical_differentiation.calculate_forward_differences_derivatives(*this, &NumericalDifferentiationTest::f2_1, dummy_index, x_1d);

    assert_true(abs(d_4(0) - d2_4(0)) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(d_4(1) - d2_4(1)) < type(NUMERIC_LIMITS_MIN), LOG);
    ...
    d2_4 = numerical_differentiation.calculate_central_differences_derivatives(*this, &NumericalDifferentiationTest::f2_1, dummy_index, x_1d);
...
void NumericalDifferentiationTest::test_calculate_forward_differences_second_derivatives()
{
    ...
    type derivatives = numerical_differentiation.calculate_forward_differences_second_derivatives(*this, &NumericalDifferentiationTest::f1, x);
    type derivatives_1 = numerical_differentiation.calculate_forward_differences_second_derivatives(*this, &NumericalDifferentiationTest::f1_1, x);
    type derivatives_2 = numerical_differentiation.calculate_forward_differences_second_derivatives(*this, &NumericalDifferentiationTest::f1_2, x);
    ...
    Tensor<type, 1> d2 = numerical_differentiation.calculate_forward_differences_second_derivatives(*this, &NumericalDifferentiationTest::f2, x_2);
    ...
    Tensor<type, 1> d3 = numerical_differentiation.calculate_forward_differences_second_derivatives(*this, &NumericalDifferentiationTest::f2_1, dummy_index, x_3);
...
void NumericalDifferentiationTest::test_calculate_central_differences_second_derivatives()
{
   ...
   type derivatives = numerical_differentiation.calculate_central_differences_second_derivatives(*this, &NumericalDifferentiationTest::f1, x);
   type derivatives_1 = numerical_differentiation.calculate_central_differences_second_derivatives(*this, &NumericalDifferentiationTest::f1_1, x);
   type derivatives_2 = numerical_differentiation.calculate_central_differences_second_derivatives(*this, &NumericalDifferentiationTest::f1_2, x);
   ...
   Tensor<type, 1> d2 = numerical_differentiation.calculate_central_differences_second_derivatives(*this, &NumericalDifferentiationTest::f2, x_2);
   ...
   Tensor<type, 1> d3 = numerical_differentiation.calculate_central_differences_second_derivatives(*this, &NumericalDifferentiationTest::f2_1, dummy_index, x_3);
...
void NumericalDifferentiationTest::test_calculate_second_derivatives()
{
    ...
    type derivatives1 = numerical_differentiation.calculate_forward_differences_second_derivatives(*this, &NumericalDifferentiationTest::f1, x);
    type derivatives1_1 = numerical_differentiation.calculate_forward_differences_second_derivatives(*this, &NumericalDifferentiationTest::f1_1, x);
    type derivatives1_2 = numerical_differentiation.calculate_forward_differences_second_derivatives(*this, &NumericalDifferentiationTest::f1_2, x);

    assert_true(abs(derivatives - derivatives1) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(derivatives_1 - derivatives1_1) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(derivatives_2 - derivatives1_2) < type(NUMERIC_LIMITS_MIN), LOG);
    ...
    derivatives1 = numerical_differentiation.calculate_central_differences_second_derivatives(*this, &NumericalDifferentiationTest::f1, x);
    derivatives1_1 = numerical_differentiation.calculate_central_differences_second_derivatives(*this, &NumericalDifferentiationTest::f1_1, x);
    derivatives1_2 = numerical_differentiation.calculate_central_differences_second_derivatives(*this, &NumericalDifferentiationTest::f1_2, x);
    ...
    Tensor<type, 1> x_1(2);
    x_1.setValues({type(1),type(2)});

    numerical_differentiation.set_numerical_differentiation_method(NumericalDifferentiation::NumericalDifferentiationMethod::ForwardDifferences);

    Tensor<type, 1> d_1 = numerical_differentiation.calculate_second_derivatives(*this, &NumericalDifferentiationTest::f2, x_1);
    Tensor<type, 1> d1_1 = numerical_differentiation.calculate_forward_differences_second_derivatives(*this, &NumericalDifferentiationTest::f2, x_1);

    assert_true(abs(d_1(0) - d1_1(0)) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(d_1(1) - d1_1(1)) < type(NUMERIC_LIMITS_MIN), LOG);

    // Test 2_1

    numerical_differentiation.set_numerical_differentiation_method(NumericalDifferentiation::NumericalDifferentiationMethod::CentralDifferences);

    d_1 = numerical_differentiation.calculate_second_derivatives(*this, &NumericalDifferentiationTest::f2, x_1);
    d1_1 = numerical_differentiation.calculate_central_differences_second_derivatives(*this, &NumericalDifferentiationTest::f2, x_1);
    ...
    d_1 = numerical_differentiation.calculate_second_derivatives(*this, &NumericalDifferentiationTest::f2_1, dummy_index, x_1);
    d1_1 = numerical_differentiation.calculate_forward_differences_second_derivatives(*this, &NumericalDifferentiationTest::f2_1, dummy_index, x_1);
    ...
    d_1 = numerical_differentiation.calculate_second_derivatives(*this, &NumericalDifferentiationTest::f2_1, dummy_index, x_1);
    d1_1 = numerical_differentiation.calculate_central_differences_second_derivatives(*this, &NumericalDifferentiationTest::f2_1, dummy_index, x_1);
...
//   Tensor<type, 1> d5 = numerical_differentiation.calculate_forward_differences_gradient(*this, &NumericalDifferentiationTest::f4_3, dummy_5, x3_1d);
...
void NumericalDifferentiationTest::test_calculate_training_loss_gradient()
{
    ...
    Tensor<type, 1> derivatives1 = numerical_differentiation.calculate_forward_differences_gradient(*this, &NumericalDifferentiationTest::f4, x_1d);

    assert_true(abs(derivatives(0) - derivatives1(0)) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(derivatives(1) - derivatives1(1)) < type(NUMERIC_LIMITS_MIN), LOG);
    ...
    derivatives1 = numerical_differentiation.calculate_central_differences_gradient(*this, &NumericalDifferentiationTest::f4, x_1d);
    ...
    Tensor<type, 1> d_2 = numerical_differentiation.calculate_gradient(*this, &NumericalDifferentiationTest::f4_1, x_1d);
    Tensor<type, 1> d1_2 = numerical_differentiation.calculate_forward_differences_gradient(*this, &NumericalDifferentiationTest::f4_1, x_1d);

    assert_true(abs(d_2(0) - d1_2(0)) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(d_2(1) - d1_2(1)) < type(NUMERIC_LIMITS_MIN), LOG);

    // Test 2_1

    numerical_differentiation.set_numerical_differentiation_method(NumericalDifferentiation::NumericalDifferentiationMethod::CentralDifferences);

    d_2 = numerical_differentiation.calculate_gradient(*this, &NumericalDifferentiationTest::f4_1, x_1d);
    d1_2 = numerical_differentiation.calculate_central_differences_gradient(*this, &NumericalDifferentiationTest::f4_1, x_1d);
    ...
    /*
    numerical_differentiation.set_numerical_differentiation_method(NumericalDifferentiation::NumericalDifferentiationMethod::ForwardDifferences);
    Tensor<type, 1> d_3 = numerical_differentiation.calculate_gradient(*this, &NumericalDifferentiationTest::f4_4, dummy, x3_1d);
    Tensor<type, 1> d1_3 = numerical_differentiation.calculate_forward_differences_gradient(*this, &NumericalDifferentiationTest::f4_4, dummy, x3_1d);

    assert_true(abs(d_3(0) - d1_3(0)) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(d_3(1) - d1_3(1)) < type(NUMERIC_LIMITS_MIN), LOG);
    
    // Test 3_1

    numerical_differentiation.set_numerical_differentiation_method(NumericalDifferentiation::NumericalDifferentiationMethod::CentralDifferences);

    d_3 = numerical_differentiation.calculate_gradient(*this, &NumericalDifferentiationTest::f4_4, dummy, x3_1d);
    d1_3 = numerical_differentiation.calculate_central_differences_gradient(*this, &NumericalDifferentiationTest::f4_4, dummy, x3_1d);
    ...
    */
    ...
    Tensor<type, 1> d_4 = numerical_differentiation.calculate_gradient(*this, &NumericalDifferentiationTest::f4_2, 2, x3_1d);
    Tensor<type, 1> d1_4 = numerical_differentiation.calculate_forward_differences_gradient(*this, &NumericalDifferentiationTest::f4_2, 2, x3_1d);

    assert_true(abs(d_4(0) - d1_4(0)) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(d_4(1) - d1_4(1)) < type(NUMERIC_LIMITS_MIN), LOG);

    // Test 4_1

    numerical_differentiation.set_numerical_differentiation_method(NumericalDifferentiation::NumericalDifferentiationMethod::CentralDifferences);

    d_4 = numerical_differentiation.calculate_gradient(*this, &NumericalDifferentiationTest::f4_2, 2, x3_1d);
    d1_4 = numerical_differentiation.calculate_central_differences_gradient(*this, &NumericalDifferentiationTest::f4_2, 2, x3_1d);
    ...
    Tensor<type, 1> d_5 = numerical_differentiation.calculate_gradient(*this, &NumericalDifferentiationTest::f4_4, dummy_5, x3_1d);
    Tensor<type, 1> d1_5 = numerical_differentiation.calculate_forward_differences_gradient(*this, &NumericalDifferentiationTest::f4_4, dummy_5, x3_1d);

    assert_true(abs(d_5(0) - d1_5(0)) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(d_5(1) - d1_5(1)) < type(NUMERIC_LIMITS_MIN), LOG);
    
    // Test 5_1

    numerical_differentiation.set_numerical_differentiation_method(NumericalDifferentiation::NumericalDifferentiationMethod::CentralDifferences);

    d_5 = numerical_differentiation.calculate_gradient(*this, &NumericalDifferentiationTest::f4_4, dummy_5, x3_1d);
    d1_5 = numerical_differentiation.calculate_central_differences_gradient(*this, &NumericalDifferentiationTest::f4_4, dummy_5, x3_1d);
...
void NumericalDifferentiationTest::test_calculate_Jacobian()
{
   ...
   Tensor<type, 2> J_1 = numerical_differentiation.calculate_forward_differences_Jacobian(*this, &NumericalDifferentiationTest::f2, x_1d);

   assert_true(J.dimension(0) == 2, LOG);
   assert_true(J.dimension(1) == 2, LOG);

   assert_true(abs(J(0,0) - J_1(0,0)) < type(NUMERIC_LIMITS_MIN), LOG);
   assert_true(abs(J(1,0) - J_1(1,0)) < type(NUMERIC_LIMITS_MIN), LOG);
   ...
   J_1 = numerical_differentiation.calculate_central_differences_Jacobian(*this, &NumericalDifferentiationTest::f2, x_1d);
   ...
   Tensor<type, 2> J_2 = numerical_differentiation.calculate_Jacobian(*this, &NumericalDifferentiationTest::f2_2, dummy, x_1d);
   Tensor<type, 2> J1_2 = numerical_differentiation.calculate_forward_differences_Jacobian(*this, &NumericalDifferentiationTest::f2_2, dummy, x_1d);

   assert_true(J_2.dimension(0) == 2, LOG);
   assert_true(J_2.dimension(1) == 2, LOG);

   assert_true(abs(J_2(0,0) - J1_2(0,0)) < type(NUMERIC_LIMITS_MIN), LOG);
   assert_true(abs(J_2(1,0) - J1_2(1,0)) < type(NUMERIC_LIMITS_MIN), LOG);

   // Test 2_1

   numerical_differentiation.set_numerical_differentiation_method(NumericalDifferentiation::NumericalDifferentiationMethod::CentralDifferences);

   J_2 = numerical_differentiation.calculate_Jacobian(*this, &NumericalDifferentiationTest::f2_2, dummy, x_1d);
   J1_2 = numerical_differentiation.calculate_central_differences_Jacobian(*this, &NumericalDifferentiationTest::f2_2, dummy, x_1d);
   ...
   Tensor<type, 2> J_3 = numerical_differentiation.calculate_Jacobian(*this, &NumericalDifferentiationTest::f2_1, 2, x_1d);
   Tensor<type, 2> J1_3 = numerical_differentiation.calculate_forward_differences_Jacobian(*this, &NumericalDifferentiationTest::f2_1, 2, x_1d);

   assert_true(J_3.dimension(0) == 2, LOG);
   assert_true(J_3.dimension(1) == 2, LOG);

   assert_true(abs(J_3(0,0) - J1_3(0,0)) < type(NUMERIC_LIMITS_MIN), LOG);
   assert_true(abs(J_3(1,0) - J1_3(1,0)) < type(NUMERIC_LIMITS_MIN), LOG);

   // Test 3_1

   numerical_differentiation.set_numerical_differentiation_method(NumericalDifferentiation::NumericalDifferentiationMethod::CentralDifferences);

   J_3 = numerical_differentiation.calculate_Jacobian(*this, &NumericalDifferentiationTest::f2_1, 2, x_1d);
   J1_3 = numerical_differentiation.calculate_central_differences_Jacobian(*this, &NumericalDifferentiationTest::f2_1, 2, x_1d);
   ...
   Tensor<type, 2> J_4 = numerical_differentiation.calculate_Jacobian(*this, &NumericalDifferentiationTest::f5, 1, dummy_vec, x_1d);
   Tensor<type, 2> J1_4 = numerical_differentiation.calculate_forward_differences_Jacobian(*this, &NumericalDifferentiationTest::f5, 1, dummy_vec, x_1d);

   assert_true(J_4.dimension(0) == 2, LOG);
   assert_true(J_4.dimension(1) == 2, LOG);

   assert_true(abs(J_4(0,0) - J1_4(0,0)) < type(NUMERIC_LIMITS_MIN), LOG);
   assert_true(abs(J_4(1,0) - J1_4(1,0)) < type(NUMERIC_LIMITS_MIN), LOG);

   // Test 4_1

   numerical_differentiation.set_numerical_differentiation_method(NumericalDifferentiation::NumericalDifferentiationMethod::CentralDifferences);

   J_4 = numerical_differentiation.calculate_Jacobian(*this, &NumericalDifferentiationTest::f5, 1, dummy_vec, x_1d);
   J1_4 = numerical_differentiation.calculate_central_differences_Jacobian(*this, &NumericalDifferentiationTest::f5, 1, dummy_vec, x_1d);
   ...
   Tensor<type, 2> J_5 = numerical_differentiation.calculate_Jacobian(*this, &NumericalDifferentiationTest::f5_1, 2, 5, x_1d);
   Tensor<type, 2> J1_5 = numerical_differentiation.calculate_forward_differences_Jacobian(*this, &NumericalDifferentiationTest::f5_1, 2, 5, x_1d);

   assert_true(J_5.dimension(0) == 2, LOG);
   assert_true(J_5.dimension(1) == 2, LOG);

   assert_true(abs(J_5(0,0) - J1_5(0,0)) < type(NUMERIC_LIMITS_MIN), LOG);
   assert_true(abs(J_5(0,1) - J1_5(0,1)) < type(NUMERIC_LIMITS_MIN), LOG);
   assert_true(abs(J_5(1,0) - J1_5(1,0)) < type(NUMERIC_LIMITS_MIN), LOG);
   assert_true(abs(J_5(1,1) - J1_5(1,1)) < type(NUMERIC_LIMITS_MIN), LOG);

   // Test 5

   numerical_differentiation.set_numerical_differentiation_method(NumericalDifferentiation::NumericalDifferentiationMethod::CentralDifferences);

   J_5 = numerical_differentiation.calculate_Jacobian(*this, &NumericalDifferentiationTest::f5_1, 2, 5, x_1d);
   J1_5 = numerical_differentiation.calculate_central_differences_Jacobian(*this, &NumericalDifferentiationTest::f5_1, 2, 5, x_1d);
