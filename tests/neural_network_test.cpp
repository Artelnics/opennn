...
TEST(NeuralNetworkTest, ForwardPropagate)
{
    ...
    EXPECT_NEAR(perceptron_activations(0, 0) - type(0.5), type(1e-1), type(1e-1));
    EXPECT_NEAR(perceptron_activations(1, 0) - type(0.5), type(1e-1), type(1e-1));
    EXPECT_NEAR(perceptron_activations(2, 0) - type(0.5), type(1e-1), type(1e-1));
    EXPECT_NEAR(perceptron_activations(3, 0) - type(0.5), type(1e-1), type(1e-1));
    EXPECT_NEAR(perceptron_activations(4, 0) - type(0.5), type(1e-1), type(1e-1));
    ...
    EXPECT_NEAR(probabilistic_activations(0, 0) - type(0.5), type(1e-1), type(1e-1));
    EXPECT_NEAR(probabilistic_activations(1, 0) - type(0.5), type(1e-1), type(1e-1));
    EXPECT_NEAR(probabilistic_activations(2, 0) - type(0.5), type(1e-1), type(1e-1));
    EXPECT_NEAR(probabilistic_activations(3, 0) - type(0.5), type(1e-1), type(1e-1));
    EXPECT_NEAR(probabilistic_activations(4, 0) - type(0.5), type(1e-1), type(1e-1));
}
