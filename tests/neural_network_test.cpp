...
//    EXPECT_EQ(outputs.size(), batch_size * outputs_number);
    ...
    //EXPECT_EQ(abs(outputs(0,0)), type(0), NUMERIC_LIMITS_MIN);
    EXPECT_EQ(abs(outputs(0,1)), type(0), NUMERIC_LIMITS_MIN);
    ...
    //EXPECT_EQ(abs(outputs(0, 0)), 0, type(1.4013e-45));
    //EXPECT_EQ(abs(outputs(0,1)), 0, type(1.4013e-45));
