...
void NeuralNetworkTest::test_constructor()
{
  ...
  assert_true(neural_network_3.get_layer_pointer(1)->get_type() == Layer::Type::LongShortTermMemory, LOG);
...
void NeuralNetworkTest::test_get_trainable_layers()
{
   ...
   assert_true(neural_network.get_trainable_layers_pointers()(0)->get_type() == Layer::Type::Perceptron, LOG);
   assert_true(neural_network.get_trainable_layers_pointers()(1)->get_type() == Layer::Type::Probabilistic, LOG);
   ...
   assert_true(neural_network.get_trainable_layers_pointers()(1)->get_type() == Layer::Type::Perceptron, LOG);
   assert_true(neural_network.get_trainable_layers_pointers()(2)->get_type() == Layer::Type::Pooling, LOG);
   assert_true(neural_network.get_trainable_layers_pointers()(3)->get_type() == Layer::Type::Probabilistic, LOG);
   assert_true(neural_network.get_trainable_layers_pointers()(4)->get_type() == Layer::Type::LongShortTermMemory, LOG);
   assert_true(neural_network.get_trainable_layers_pointers()(5)->get_type() == Layer::Type::Recurrent, LOG);
...
void NeuralNetworkTest::test_get_layers_type_pointers()
{
   ...
   assert_true(neural_network.get_unscaling_layer_pointer()->get_type() == Layer::Type::Unscaling, LOG);
   assert_true(neural_network.get_bounding_layer_pointer()->get_type() == Layer::Type::Bounding, LOG);
   assert_true(neural_network.get_probabilistic_layer_pointer()->get_type() == Layer::Type::Probabilistic, LOG);
   assert_true(neural_network.get_long_short_term_memory_layer_pointer()->get_type() == Layer::Type::LongShortTermMemory, LOG);
   assert_true(neural_network.get_recurrent_layer_pointer()->get_type() == Layer::Type::Recurrent, LOG);

   assert_true(neural_network.get_first_perceptron_layer_pointer()->get_type() == Layer::Type::Perceptron, LOG);
...
void NeuralNetworkTest::test_get_layer_pointer()
{
   ...
   assert_true(neural_network.get_layer_pointer(0)->get_type() == Layer::Type::Scaling, LOG);
   assert_true(neural_network.get_layer_pointer(1)->get_type() == Layer::Type::Convolutional, LOG);
   assert_true(neural_network.get_layer_pointer(2)->get_type() == Layer::Type::Perceptron, LOG);
   assert_true(neural_network.get_layer_pointer(3)->get_type() == Layer::Type::Pooling, LOG);
   assert_true(neural_network.get_layer_pointer(4)->get_type() == Layer::Type::Probabilistic, LOG);
   assert_true(neural_network.get_layer_pointer(5)->get_type() == Layer::Type::LongShortTermMemory, LOG);
   assert_true(neural_network.get_layer_pointer(6)->get_type() == Layer::Type::Recurrent, LOG);
   assert_true(neural_network.get_layer_pointer(7)->get_type() == Layer::Type::Unscaling, LOG);
   assert_true(neural_network.get_layer_pointer(8)->get_type() == Layer::Type::Bounding, LOG);
}
...
//   ConvolutionalLayer convolutional_layer(1,1); //CC -> cl(inputs_dim, filters_dim)
   ...
   neural_network.set(NeuralNetwork::ProjectType::Classification, {1,1,1,1});
   assert_true(neural_network.get_inputs_names().size() == 1, LOG);
   assert_true(neural_network.get_outputs_names().size() == 1, LOG);
   assert_true(neural_network.get_layers_pointers().size() == 4, LOG);
*/
...
void NeuralNetworkTest::test_get_architecture()
{
   ...
   neural_network.set(NeuralNetwork::ProjectType::Approximation, {1,4,2});
...
void NeuralNetworkTest::test_get_parameters()
{
   ...
   perceptron_layer_pointer->set_biases_constant(type(0));
   perceptron_layer_pointer->set_synaptic_weights_constant(type(1));

   perceptron_layer_pointer = static_cast<PerceptronLayer*>(neural_network.get_layer_pointer(2));
   perceptron_layer_pointer->set_biases_constant(type(2));
   perceptron_layer_pointer->set_synaptic_weights_constant(type(3));

   parameters = neural_network.get_parameters();

   assert_true(parameters.size() == 7, LOG);
   assert_true(neural_network.get_parameters_number() == parameters.size(), LOG);
   assert_true(abs(parameters(1)) < type(NUMERIC_LIMITS_MIN), LOG);
   ...
   perceptron_layer_pointer->set_biases_constant(type(4));
   perceptron_layer_pointer->set_synaptic_weights_constant(type(5));
   ...
   assert_true(abs(parameters(2) - type(2)) < type(NUMERIC_LIMITS_MIN), LOG);
   assert_true(abs(parameters(3) - type(3)) < type(NUMERIC_LIMITS_MIN), LOG);
   assert_true(abs(parameters(4) - type(4)) < type(NUMERIC_LIMITS_MIN), LOG);
   assert_true(abs(parameters(5) - type(5)) < type(NUMERIC_LIMITS_MIN), LOG);
   ...
   perceptron_layer_pointer->set_biases_constant(type(6));
   perceptron_layer_pointer->set_synaptic_weights_constant(type(7));

   parameters = neural_network.get_parameters();

   assert_true(parameters.size() == 8, LOG);
   assert_true(neural_network.get_parameters_number() == parameters.size(), LOG);
   assert_true(abs(parameters(0) - type(0)) < type(NUMERIC_LIMITS_MIN), LOG);
   assert_true(abs(parameters(1) - type(1)) < type(NUMERIC_LIMITS_MIN), LOG);
   assert_true(abs(parameters(2) - type(2)) < type(NUMERIC_LIMITS_MIN), LOG);
   assert_true(abs(parameters(3) - type(3)) < type(NUMERIC_LIMITS_MIN), LOG);
   assert_true(abs(parameters(4) - type(4)) < type(NUMERIC_LIMITS_MIN), LOG);
   assert_true(abs(parameters(5) - type(5)) < type(NUMERIC_LIMITS_MIN), LOG);
   assert_true(abs(parameters(6) - type(6)) < type(NUMERIC_LIMITS_MIN), LOG);
   assert_true(abs(parameters(7) - type(7)) < type(NUMERIC_LIMITS_MIN), LOG);
}
...
void NeuralNetworkTest::test_get_trainable_layers_parameters()
{
    ...
    neural_network.set(NeuralNetwork::ProjectType::Approximation, {1,2,1});
    neural_network.set_parameters_constant(type(0.0));
    parameters = neural_network.get_parameters();
    trainable_layers_parameters = neural_network.get_trainable_layers_parameters(parameters);
    ...
    assert_true(abs(trainable_layers_parameters(0)(0)) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(trainable_layers_parameters(0)(3)) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(trainable_layers_parameters(1)(0)) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(trainable_layers_parameters(1)(2)) < type(NUMERIC_LIMITS_MIN), LOG);
    ...
    assert_true(abs(trainable_layers_parameters(0)(0) - type(0)) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(trainable_layers_parameters(0)(1) - type(1)) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(trainable_layers_parameters(1)(0) - type(2)) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(trainable_layers_parameters(1)(1) - type(3)) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(trainable_layers_parameters(2)(0) - type(4)) < type(NUMERIC_LIMITS_MIN), LOG);
    assert_true(abs(trainable_layers_parameters(2)(1) - type(5)) < type(NUMERIC_LIMITS_MIN), LOG);
}
...
/*
   ...
   assert_true(abs(outputs(0,0) - type(2)) < type(NUMERIC_LIMITS_MIN), LOG);
   assert_true(abs(outputs(0,1) - tanh(3)) < type(NUMERIC_LIMITS_MIN), LOG);
...
void NeuralNetworkTest::test_write_expression()
{
   ...
   neural_network.set(NeuralNetwork::ProjectType::Classification, {2, 4, 3});
...
/*
    ...
    perceptron_layer->set_activation_function(PerceptronLayer::Type::Logistic);
    ...
    perceptron_layer_3->set_activation_function(PerceptronLayer::Type::Logistic);
    ...
    probabilistic_layer_3->set_activation_function(ProbabilisticLayer::Type::Softmax);
