...
## Results (2026-07-06, avr-gcc 7.3.0, simavr 1.6, arm-none-eabi-gcc 15.2.1, QEMU 9.2.4)
    ...
    lstm/expression   42538 B -> DOES NOT FIT  passes       2.4e-07 (PC/ARM)
    lstm/tables        4296 B  passes          passes       2.4e-07 AVR, bit-exact PC=ARM
    rnn/expression    12206 B  passes          passes       4.7e-07
    rnn/tables         3394 B  passes          passes       4.7e-07 AVR, bit-exact PC=ARM
