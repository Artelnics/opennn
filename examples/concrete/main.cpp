...
int main()
{
    try
    {
        ...
        cout << "\n[Single Objective Experiment] Minimizing effluent_violation_index..." << endl;

        optimizer.set_condition("effluent_violation_index", ResponseOptimization::ConditionType::Minimize);

        MatrixR single_results = optimizer.perform_response_optimization();

        cout << "Optimal Recipe for Min effluent_violation_index:" << endl;
        ...
        cout << "\n[Multi-Objective Experiment] Min total_operational_cost & Min effluent_violation_index..." << endl;
        ...
        optimizer.set_condition("effluent_violation_index", ResponseOptimization::ConditionType::Minimize);
        optimizer.set_condition("total_operational_cost", ResponseOptimization::ConditionType::Minimize);
