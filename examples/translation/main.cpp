...
//         //alvaro
//         Tensor<string, 1>& completion_vocabulary = Tensor<string, 1>(); //language_data_set.get_completion_vocabulary();
//         Tensor<string, 1>& context_vocabulary = Tensor<string, 1>(); //language_data_set.get_context_vocabulary();
