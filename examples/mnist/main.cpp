...
int main()
{
    try
    {
        ...
        Tensor<unsigned char,1> zero = data_set.read_bmp_image_optimized("../data/images/zero/0_1.bmp");
        Tensor<unsigned char,1> one = data_set.read_bmp_image_optimized("../data/images/one/1_1.bmp");
