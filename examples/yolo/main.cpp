...
int main(int argc, char* argv[])
{
    try
    {
        ...
        // A binary at epoch 0 means pretrained starting point (e.g. from yolov8s_to_nd.py).
        // Trigger the backbone freeze warmup so head gradients don't corrupt pretrained features.
        if (weights_exist && epochs_done == 0)
