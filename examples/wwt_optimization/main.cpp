...
int main()
{
    try
    {
        ...
        else
        {
            ...
            NeuronsSelectionResults neuron_results = growing_neurons.perform_neurons_selection();
        ...
        try
        {
            ...
            cout << "Parameters count: " << forecasting_network->get_parameters_size() << endl;
            cout << "Parameters number: " << forecasting_network->get_parameters_number() << endl;
            cout.flush();
            ...
            {
                const Index actual_batch = min<Index>(test_batch, time_series_dataset.Dataset::get_samples_number("Testing"));
